...
static int stm32_uart_dma_init(struct UART_Device *pDev, int baud, char parity, int stop);
static int stm32_uart_dma_send(struct UART_Device *pDev, uint8_t *data, int len, int timeout_ms);
static int stm32_uart_dma_recv(struct UART_Device *pDev, uint8_t *data, int timeout_ms);
...
static struct UART_Device stm32_uart1 = {
    ...
    .Init = stm32_uart_dma_init,
    .Send = stm32_uart_dma_send,
    .Recv = stm32_uart_dma_recv
};
